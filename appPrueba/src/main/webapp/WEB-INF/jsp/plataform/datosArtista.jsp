				...
				<div class="content">
					<div class="single-page"><br />
						...
						<div class="product-info">
							...
							<div class="clear"> </div>
								...
								<div class="products">
						<h5><span>ARTISTAS SIMILARES</span> SEGÚN SU VALORACIÓN</h5>
					...
					<c:forEach items="${listaArtistas}" var="listaArtistas">
							<div class="grid_1_of_5 images_1_of_5">
							     ...
							     <div class="button"><span><a href="artistaRecommend?idArtista=<c:out value="${listaArtistas.idArtista}" />">Ver Más</a></span></div>
						   </div>
 					</c:forEach>
