				...
				<div class="content">
					...
					<div class="products">
						...
						<c:forEach items="${cancionesTop6}" var="cancionesTop6">
							<div class="grid_1_of_5 images_1_of_5">
							     ...
							     <div class="button"><span><a href="itemRecommend?codCancion=<c:out value="${cancionesTop6.codCancion}" />">Ver Más</a></span></div>
						   </div>
					 </c:forEach>
						</div>
					...
					<div class="products products-secondbox">
						...
						<c:forEach items="${artistaTop6}" var="artistaTop6">
					     ...
					     <div class="button"><span><a href="artistaRecommend?idArtista=<c:out value="${artistaTop6.idArtista}" />">Ver más</a></span></div>
								   </div>
